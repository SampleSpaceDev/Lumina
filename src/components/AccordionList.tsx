export {}
// import React, { Component, ComponentProps, memo, useEffect, useState } from "react";
// import Cookies from "js-cookie";
// import { DragDropContext, Draggable, Droppable } from "react-beautiful-dnd";
// import { HorizontalLine as HLine } from "./HorizontalLine";
// import { ReactIcon } from "./ReactIcon";
// import { FaSortAlphaDown } from "react-icons/fa";
// import { RiCheckboxIndeterminateFill, RiCheckboxIndeterminateLine } from "react-icons/ri";
//
// export function AccordionList({ cookie, accordionModule }: { cookie: string, accordionModule: any }) {
//
...
//
//     function getCookie(): {list: string[], showLine: boolean} {
...
//     }
//
//     function getAccordionFromString(str: string): React.Component {
//         // Finds the matching component from within the Accordion module
//         for (const [name: string, component] of Object.entries(accordionModule)) {
//             if (name === str) {
//                 return component;
//             }
//         }
...
// */
// const HorizontalLine = memo((props: ComponentProps<any>) => {
//     return (
